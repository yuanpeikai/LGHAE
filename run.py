...
class Main(object):
    ...
    def add_model(self):
        ...
        if self.p.model_name == 'Hyper_InteractE':
            model = Hyper_InteractE(self.p)
...
if __name__ == "__main__":
    ...
    # Training parameters
    parser.add_argument("--gpu", type=str, default='1', help='GPU to use, set -1 for CPU')
    ...
    parser.add_argument("--model_name", type=str, default='Hyper_InteractE', help='')
